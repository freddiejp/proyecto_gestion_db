...
const { startClass, joinClass, endClass } = require('../controllers/classController');
const { verifyToken, isProfesor } = require('../middlewares/authMiddleware');
const validate = require('../middlewares/validate');
const { startClassValidator, classIdParamValidator } = require('../validators/classValidators');
